...
export default function CourseCardSearch({ course, isSelected, onClick }: SearchCourseCardProps) {
        ...
        >
            ...
            <div className='course-card-search__content'>
                <div>
                    ...
                    <p className='course-card-search__description'>{course.description}
                    </p>
                </div>
                <div className='mt-2'>
